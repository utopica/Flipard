...
namespace Flipard.Persistence.Migrations
{
    ...
    [Migration("20241230122212_badge")]
    partial class badge
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flipard.Domain.Entities.Badge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Flipard.Domain.Entities.UserBadge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Flipard.Domain.Entities.UserLevel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset>("LastLevelUpDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Flipard.Domain.Entities.UserBadge", b =>
                {
                    b.HasOne("Flipard.Domain.Entities.Badge", "Badge")
                        .WithMany("UserBadges")
